 ...
 */
public abstract class TheGame extends GestureDetector.SimpleOnGestureListener{
    public TheGame(MainActivity act, int score) throws Exception{
        mScore = score;
        mLost = false;
        mAct =act;
    ...
    protected void soundWin() {
        mAct.playSoundWin();
    }

    protected void soundDeath() {
        mAct.playSoundDeath();
    }

    protected void soundLaserStart() {
        mAct.playSoundLaser();
    }

    protected void soundLaserStop() {
        //mAct.stopSoundLaser();
    }

    public abstract void resetGame() throws Exception;
    ...
    protected static final String TAG="TheGame";
    /**
